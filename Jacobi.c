/*Método de Jacobi para o sistema de equaçâo:
2x+y = 1
x+2y = 3
com erro<=10^-2 e valor inicial [0 , 0]
*/
#include<stdio.h>
#include <math.h>
    ...
    do
    {
        ...
        */
        else
        {
            ...
            Aqui é onde se encontra a diferença entre os métodos (Jacobi e Gauss), uma vez que 'y' recebe 'xa', que é o valor anterior
            de 'x' afim de atualizar o 'y', ao contrário do de Gauss que recebe o 'x' já atualizado.
